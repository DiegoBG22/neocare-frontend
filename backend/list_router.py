...
from schemas import ListModel as ListSchema, ListCreate   # ✅ Import corregido
...
async def list_lists_for_board(
    ...
    return lists   # FastAPI convierte automáticamente gracias a orm_mode
...
async def create_list(
    ...
    return new_list   # FastAPI convierte automáticamente gracias a orm_mode
