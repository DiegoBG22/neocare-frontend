...
def report_summary(
    ...
    # Completadas: tarjetas marcadas como completadas y actualizadas dentro de la semana
    completed_rows = (
        db.query(
            Card.id.label("card_id"),
            Card.title.label("title"),
    ...
    # Vencidas: tarjetas marcadas como vencidas y actualizadas dentro de la semana
    overdue_rows = (
        db.query(
            Card.id.label("card_id"),
            Card.title.label("title"),
