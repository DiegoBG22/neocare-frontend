...
Tablero Kanban: Con columnas "Por hacer" → "En curso" → "Hecho".
Gestión de Tareas: Creación, edición y movimiento (drag & drop) de tarjetas con título, descripción, fecha límite y responsable.
Registro de Horas (Timesheets): Introducir fecha, horas y notas trabajadas por tarjeta.
Informe Semanal: Generación de métricas (tareas completadas/vencidas, horas totales por persona/tarjeta) y exportación a CSV.
Seguridad: Acceso mediante login interno y API backend segura.
