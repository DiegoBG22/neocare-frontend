...
Verificar backend: Acceder a http://localhost:8000/health

Verificar frontend: Acceder a http://localhost:5173

Probar endpoints: Usar Postman/Thunder Client para probar /register y /login
